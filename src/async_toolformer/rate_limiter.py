...
from .config import RateLimitConfig, BackpressureStrategy
...
class RateLimiter(ABC):
    ...
    @abstractmethod
    async def get_info(self, key: str) -> Optional[RateLimitInfo]:
...
class AdaptiveRateLimiter(RateLimiter):
    ...
    def __init__(
        ...
        load_factor_callback: Optional[callable] = None
    ):
