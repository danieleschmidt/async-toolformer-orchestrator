...
class MetricsCollector:
    ...
    def increment_counter(self, name: str, labels: dict[str, str] | None = None, value: float = 1.0) -> None:
    ...
    def add_custom_metric(self, name: str, value: float, labels: dict[str, str] | None = None) -> None:
...
def track_metric(metric_name: str, metric_type: str = "counter", labels: dict[str, str] | None = None):
...
@asynccontextmanager
async def measure_time(metric_name: str, labels: dict[str, str] | None = None):
...
class OpenTelemetrySetup:
    ...
    @asynccontextmanager
    async def trace_span(self, name: str, attributes: dict[str, Any] | None = None):
