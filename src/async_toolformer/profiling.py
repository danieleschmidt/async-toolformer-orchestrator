...
class ProfilingResult:
    ...
    profile_data: pstats.Stats | None = None
    ...
    def get_top_functions(self, count: int = 10) -> list[dict[str, Any]]:
        ...
        stats = []
        for func, (_cc, nc, tt, ct, _callers) in self.profile_data.stats.items():
            stats.append({
...
class AsyncProfiler:
    ...
    def get_profile(self, name: str) -> ProfilingResult | None:
    ...
    def generate_report(self, name: str, output_file: str | None = None) -> str:
...
def profile_async(name: str | None = None, profiler: AsyncProfiler | None = None):
...
_global_profiler: AsyncProfiler | None = None
